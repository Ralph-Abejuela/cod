      ...
      <header className="sticky top-0 z-50 border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="mx-auto flex h-14 max-w-7xl items-center justify-between px-6">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm text-muted-foreground">Beneficiary Management</span>
          </div>
          <nav className="flex items-center gap-2">
            ...
            <Link href="/beneficiary">
              <Button variant="ghost" size="sm" className="font-semibold">Beneficiaries</Button>
            </Link>
          </nav>
        </div>
      </header>
      ...
      <main className="mx-auto max-w-7xl px-6 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-sm text-muted-foreground">
            Register for a government program or track your existing application.
          </p>
        </div>
